...
Consent to contact: ${formData.consent ? 'Yes' : 'No'}
      ...
      const mailtoLink = `mailto:info@usenupitch.com?subject=New Waitlist Signup - ${formData.name}&body=${encodeURIComponent(emailBody)}`;
          ...
          <div className="mb-8">
            <label className="flex items-start space-x-3 cursor-pointer">
              ...
              <span className="text-gray-300 text-sm leading-relaxed">
                I agree to be contacted by NuPitch Technologies regarding their services and updates. <span className="text-red-400">*</span>
              </span>
            </label>
          </div>
